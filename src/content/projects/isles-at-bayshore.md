...
### Lo-fi Wireframes
To show my vision for the redesign of the content to the rest of the team, I created some basic low-fi sketches with content structure and page layouts. 
...
* **Email Marketing:** Email is one of the highest converting channels throughout the real estate industry, so email captures and marketing campaigns were implemented to convert more subscribers to customers and increase returns.
...
### Redesign Showcase
For the redesign, I focused on keeping a professional but fresh look. The main color used was blue, with a red CTA, which after A/B testing performed the best. The content remained very close to the original, except for some sections that were removed to optimize screen loading time.

Given that the scope of this project was very large, I had to design several screens for the new layout to keep cohesiveness throughout the navigation experience. Below are examples of a few of the responsive layouts developed:
...
### Results
Although the redesign of the experience was the main focus of the project, we were able to exceed expectations thanks to the collaborative effort of everyone on the team.

The final results reduced the lead capture cost from **$65 to only $11**, and the lead generation went from an average of **40 to 90 per month**, representing a total increase of **125%**.
